      ...
      <div className="site-shell">
        <div className="mx-auto max-w-5xl space-y-5 text-center md:space-y-6">
          ...
          <p className="mx-auto max-w-2xl text-sm leading-7 text-muted-foreground sm:text-base md:text-lg md:leading-8">
            Maya Haven helps clients find a property they can call home within Nairobi and beyond, while offering trusted investor consultation and management services.
          </p>
          <div className="grid gap-6 pt-4 md:grid-cols-3">
            ...
            <article className="rounded-[1.8rem] border border-black/6 bg-white/60 p-6 text-left">
              <p className="quiet-label text-[var(--gold-strong)]">Investor Support</p>
              <p className="mt-4 font-display text-2xl leading-tight">Prioritized response times, dedicated investor support, and fast turnaround communication for active mandates.</p>
            </article>
            <article className="rounded-[1.8rem] border border-black/6 bg-white/60 p-6 text-left">
              <p className="quiet-label text-[var(--gold-strong)]">Client Trust</p>
              <p className="mt-4 font-display text-2xl leading-tight">Designed for investors abroad, landlords, and families who value calm, competent representation.</p>
            </article>
          </div>
          <EarbTrustBadge className="text-left" />
