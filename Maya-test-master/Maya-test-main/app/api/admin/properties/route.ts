...
import { adminPropertySchema, createAdminProperty, getAdminProperties } from "@/services/admin-properties";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const property = await createAdminProperty(payload, session!.user!.id);
