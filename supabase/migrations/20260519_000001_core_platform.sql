...
create table if not exists public.properties (
  ...
  market_status public.property_market_status not null default 'available',
...
create index if not exists idx_properties_segment_listing_status on public.properties (segment, listing_type, market_status);
...
for select
using (soft_deleted_at is null and market_status <> 'archived');
